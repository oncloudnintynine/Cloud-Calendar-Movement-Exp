...
window.showConfirm = function(message, title, options) {
 return new Promise((resolve) => {
   ...
   modal.className = 'bg-white dark:bg-darksurface rounded-xl shadow-2xl w-full max-w-sm overflow-hidden animate-slide-up border border-transparent dark:border-darkborder';
